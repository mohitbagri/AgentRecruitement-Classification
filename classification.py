...
Removed_Features=['Application_Receipt_Date','Applicant_BirthDate','Manager_DOJ','Manager_DoB']
df2=df2.drop(Removed_Features, axis=1)
...
# Fitting the model and predicting test data results
